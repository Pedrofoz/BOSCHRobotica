...
public class TelaDeOpcoes {
	...
	public int linhaLocais;
	public int colunaLocais;
	...
	private void adicionaTexto() {
		...
		flowLayout.preferredLayoutSize(textCol);
	...
	private void criaToolbar() {
		...
		botaoSalvar.addActionListener(new ActionListener() {				
			@Override
			public void actionPerformed(ActionEvent e) {				
				linhaLocais =  Integer.parseInt(textLinha.getText().replaceAll(" ", ""));
				colunaLocais = Integer.parseInt(textCol.getText().replaceAll(" ", ""));
				System.out.println("Salvando e Gerando Mapa");		
				new TelaDefineLocais().montaTela(linhaLocais,colunaLocais);
	...
	public int getLinha(){
		System.out.println(linhaLocais);
		return linhaLocais;
	}
